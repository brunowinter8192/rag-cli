...
### R1 — Ground every query in the summary alone
...
### R2 — Lead with the primary_concept (mechanical, no interpretation)
...
### R3 — Format definitions (one query each, labeled)
...
### R4 — Register, not answer knowledge
...
### R5 — Independent formulation, not summary paraphrase
...
### R6 — Length is per-format, not global
