...
**Label:** sweep_query_prefix_False | **Timestamp:** 20260428_221609
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 8, 10)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 4, 6, 7, 9)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 1
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 6
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 9, 10)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 4, 5, 8, 9)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 7)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 4, 5, 8, 10)
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2, 4, 6)
...
- docs_voyageai_com__docs__reranker.md — Found (Rank 2)
- docs_together_ai__docs__how-to-improve-search-with-rerankers.md — MISSING
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 3, 4, 6, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 4, 5, 8, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 3, 6, 7, 9)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 3, 4, 5, 6, 7, 8, 10)
...
**Document Match:** 2/2 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 4, 5, 7)
- www_pinecone_io__learn__series__faiss__hnsw.md — Found (Rank 6, 8, 9)

**Snippet Match:** 1/2 (50%)
- "index quality tradeoff is controlled via the efConstruction parameter" — Found in Rank 5
...
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 5)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 3, 4, 6, 7, 8, 9, 10)
...
**Snippet Match:** 2/2 (100%)
- "70.58 on the MTEB Multilingual benchmark" — Found in Rank 6
...
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 4, 10)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 3, 6, 7)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 5, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 4, 9)
