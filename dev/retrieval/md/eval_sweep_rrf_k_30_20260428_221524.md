...
**Label:** sweep_rrf_k_30 | **Timestamp:** 20260428_221524
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 6, 8)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 4, 7, 10)
...
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 1, 4)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 2, 3, 5, 6, 8, 9, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 9)
