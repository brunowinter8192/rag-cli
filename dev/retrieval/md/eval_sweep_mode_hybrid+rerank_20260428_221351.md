...
**Label:** sweep_mode_hybrid+rerank | **Timestamp:** 20260428_221351

**Config:**

| Param | Value | Note |
|-------|-------|------|
| mode | hybrid+rerank ← swept |  |
| top_k | 10 |  |
| alpha | 0.8 |  |
| rrf_k | 60 |  |
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 3, 5, 7)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 2, 4, 9, 10)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 1
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 10
...
**Document Match:** 2/2 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 4, 5, 7, 9)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 3, 6, 8, 10)

**Snippet Match:** 1/2 (50%)
- "when combined with reranking, by 67%" — MISSING
- "top-20-chunk retrieval failure rate by 67% (5.7% → 1.9%)" — Found in Rank 3
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 7, 10)

**Snippet Match:** 2/2 (100%)
- "gets more than 40 MRR @ 10 on the MS MARCO dev set" — Found in Rank 1
- "SPLADE-v3 | 40.2 | 72.3 | 75.4" — Found in Rank 4
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 3, 4, 5, 7, 9)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 6)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 8, 10)
...
**Document Match:** 1/1 (100%)
- docs_haystack_deepset_ai__docs__hypothetical-document-embeddings-hyde.md — Found (Rank 1, 2, 3, 4, 5)

**Snippet Match:** 2/2 (100%)
- "this is done five times" — Found in Rank 3
- "encodes each hypothetical document into an embedding vector and averages them" — Found in Rank 3
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 4, 5)
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2, 3, 7)

**Snippet Match:** 2/2 (100%)
- "around the early 400 range is a good trade off" — Found in Rank 3
- "I will be using a 512 (for some reason I like this number)" — Found in Rank 7
...
- docs_voyageai_com__docs__reranker.md — Found (Rank 7)
- docs_together_ai__docs__how-to-improve-search-with-rerankers.md — MISSING
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 2, 3, 4, 9)
...
- "the two are complementary in how they model relevance" — Found in Rank 2
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 2, 3, 6, 7, 8)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 1, 4, 5, 9, 10)

**Snippet Match:** 2/2 (100%)
- "only afterwards dividing these contextually-rich embeddings into chunks" — Found in Rank 3
- "Segmentation boundaries are then applied to these context-aware representations" — Found in Rank 9
...
**Document Match:** 3/3 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 3, 6, 8)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4, 5, 9, 10)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — Found (Rank 7)

**Snippet Match:** 2/2 (100%)
- "uses two sub-techniques: Contextual Embeddings and Contextual BM25" — Found in Rank 1
- "prepending chunk-specific explanatory context to each chunk before embedding" — Found in Rank 3
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 3, 4, 5, 6, 8, 9, 10)
...
**Snippet Match:** 1/2 (50%)
- "SPLADE-v3 vastly outperforms BM25" — Found in Rank 1
...
**Document Match:** 2/2 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 3, 4, 5, 7)
- www_pinecone_io__learn__series__faiss__hnsw.md — Found (Rank 2, 8, 9, 10)

**Snippet Match:** 2/2 (100%)
- "index quality tradeoff is controlled via the efConstruction parameter" — Found in Rank 1
...
- "needle-question pairs increases the rate of performance degradation" — Found in Rank 2

---

## Query 16: "What are the tradeoffs between fixed-size, semantic, and LLM-guided chunking strategies for RAG retrieval quality?"

**Document Match:** 4/5 (80%)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 1, 2, 3, 5, 7, 8)
- research_trychroma_com__evaluating-chunking.md — Found (Rank 9)
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 4)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 6, 10)
...
- "Lumber Chunker performs best for in-document retrieval" — Found in Rank 3
...
- "we find RRF to be sensitive to its parameters" — Found in Rank 5
- "convex combination outperforms RRF in in-domain and out-of-domain settings" — Found in Rank 5
- "tuned RRF generalizes poorly to out-of-domain datasets" — Found in Rank 3
...
**Document Match:** 3/3 (100%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 3, 8)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 5, 6, 7, 9, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 4)

**Snippet Match:** 1/2 (50%)
- "70.58 on the MTEB Multilingual benchmark" — MISSING
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 7, 8)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 2)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 4, 5, 6)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 3, 9, 10)

**Snippet Match:** 3/3 (100%)
- "reduce the number of rows in index and reduce the concurrent queries" — Found in Rank 5
- "Are you setting your `list` size appropriately for your data set?" — Found in Rank 1
- "pgvector 0.8.0 and iterative scans work as expected" — Found in Rank 3
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 4, 9)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 5, 8, 10)
...
**Snippet Match:** 1/3 (33%)
- "prepending chunk-specific explanatory context to each chunk before embedding" — Found in Rank 10
...
| Metric | Value |
|--------|-------|
| Document Recall @10 (avg) | 84% |
| Snippet Recall @10 (avg) | 77% |
| Queries with 100% doc match | 14/20 |
