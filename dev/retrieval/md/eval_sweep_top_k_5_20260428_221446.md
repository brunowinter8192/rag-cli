...
**Label:** sweep_top_k_5 | **Timestamp:** 20260428_221446
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 3)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 4, 5)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 4)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 3)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 5)
...
**Document Match:** 1/1 (100%)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 1, 2, 3, 4, 5)
...
**Document Match:** 1/1 (100%)
- docs_haystack_deepset_ai__docs__hypothetical-document-embeddings-hyde.md — Found (Rank 1, 2, 3, 4)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 4)
...
- Fusion_Functions_Hybrid_Retrieval.md — Found (Rank 1, 2, 3, 4, 5)
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 3, 5)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 4)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 4)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 3, 5)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
...
**Document Match:** 1/2 (50%)
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 3, 4, 5)
...
- www_pinecone_io__learn__series__faiss__hnsw.md — Found (Rank 5)
...
**Document Match:** 1/1 (100%)
- research_trychroma_com__context-rot.md — Found (Rank 1, 2, 3, 4, 5)
...
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 5)
...
**Document Match:** 1/3 (33%)
- arxiv__2506.05176__qwen3-embedding.md — MISSING
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 5)
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 5)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 3, 4)
- www_thenile_dev__blog__pgvector-080.md — MISSING

**Snippet Match:** 1/3 (33%)
- "reduce the number of rows in index and reduce the concurrent queries" — Found in Rank 3
- "Are you setting your `list` size appropriately for your data set?" — MISSING
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 5)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4)
...
| Metric | Value |
|--------|-------|
| Document Recall @5 (avg) | 74% |
| Snippet Recall @5 (avg) | 57% |
