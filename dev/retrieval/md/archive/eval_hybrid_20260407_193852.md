...
**Mode:** hybrid | **Top-k:** 10 | **Timestamp:** 20260407_193852
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 6, 7, 10)
...
**Document Match:** 2/2 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 3, 6, 7)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 10)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 3, 4, 5, 7)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 6)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 8, 9, 10)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 2, 3, 4, 7)
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2, 3)
...
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 2, 3, 4, 9, 10)
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 3, 5, 6, 7)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 4, 8, 9, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 4, 5, 8, 9)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 3, 6, 7, 10)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 5, 6, 7, 9)
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 5)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 3, 4, 10)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 6, 7, 8, 9)
...
- "Lumber Chunker performs best for in-document retrieval" — Found in Rank 5
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 5, 6, 9)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 7, 8, 10)
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 3, 7)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 6, 10)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 4, 5, 9)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 3, 7)
