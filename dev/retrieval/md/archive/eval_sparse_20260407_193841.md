...
**Mode:** sparse | **Top-k:** 10 | **Timestamp:** 20260407_193841
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 5, 7, 8, 9)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 1, 2, 3, 4, 6)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 7
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 3
...
**Document Match:** 2/2 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 4, 5, 8)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 3, 6, 7)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 10)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 2, 3, 5, 6, 8, 9, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 7)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 4)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 7, 10)
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2, 5)
...
- Fusion_Functions_Hybrid_Retrieval.md — Found (Rank 1, 3, 4, 5, 6, 10)
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 4, 6, 7, 9)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 3, 5, 8, 10)

**Snippet Match:** 2/2 (100%)
- "only afterwards dividing these contextually-rich embeddings into chunks" — Found in Rank 1
- "Segmentation boundaries are then applied to these context-aware representations" — Found in Rank 5
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 3, 8)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4, 9, 10)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 3, 4, 9)
...
**Document Match:** 1/2 (50%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 4, 5, 8)
...
**Document Match:** 1/1 (100%)
- research_trychroma_com__context-rot.md — Found (Rank 1, 4, 5, 6, 7, 8, 9, 10)

**Snippet Match:** 1/2 (50%)
- "model performance degrades more significantly with increasing input length" — MISSING
- "needle-question pairs increases the rate of performance degradation" — Found in Rank 4
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 4, 7)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 5, 9, 10)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 3, 6, 8)
...
- "Lumber Chunker performs best for in-document retrieval" — Found in Rank 4
...
**Document Match:** 2/3 (66%)
- Fusion_Functions_Hybrid_Retrieval.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 8, 10)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — Found (Rank 9)
- www_anthropic_com__engineering__contextual-retrieval.md — MISSING
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 2, 7, 10)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 3, 4, 5, 6, 8, 9)
- arxiv__2511.22240__pipeline-optimization.md — MISSING

**Snippet Match:** 1/2 (50%)
- "70.58 on the MTEB Multilingual benchmark" — MISSING
- "Qwen-3 models consistently outperform BGE-M3 across all evaluated dimensions" — Found in Rank 6
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 3, 4)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 7, 10)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 5, 6)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 8)

**Snippet Match:** 2/3 (66%)
- "reduce the number of rows in index and reduce the concurrent queries" — Found in Rank 5
- "Are you setting your `list` size appropriately for your data set?" — Found in Rank 7
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 7)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 6)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
- weaviate_io__blog__late-chunking.md — Found (Rank 10)
...
**Snippet Match:** 1/3 (33%)
- "prepending chunk-specific explanatory context to each chunk before embedding" — MISSING
- "only afterwards dividing these contextually-rich embeddings into chunks" — Found in Rank 10
...
| Snippet Recall @10 (avg) | 63% |
| Queries with 100% doc match | 11/20 |
| Queries with 100% snippet match | 7/20 |
