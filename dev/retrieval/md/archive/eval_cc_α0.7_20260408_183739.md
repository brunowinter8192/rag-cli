...
**Mode:** cc_α0.7 | **Top-k:** 10 | **Timestamp:** 20260408_183739
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 6, 10)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 4, 7, 8, 9)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 8, 10)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 3, 7, 8, 9, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 4)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 5, 6)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 6, 9, 10)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 3, 4, 5, 6, 7)
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 6)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 3, 5)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 4, 7, 8, 9, 10)
...
- "Lumber Chunker performs best for in-document retrieval" — Found in Rank 6
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 6, 8, 10)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 5, 7, 9)
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 4, 8)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 6, 10)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 3, 5, 7)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 7, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 6, 9)
