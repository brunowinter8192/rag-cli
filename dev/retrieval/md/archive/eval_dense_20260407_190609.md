...
**Mode:** dense | **Top-k:** 10 | **Timestamp:** 20260407_190609
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 2, 4, 7, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 9)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 3, 5, 6, 8)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 2, 3, 6, 7, 10)
...
- docs_voyageai_com__docs__reranker.md — Found (Rank 10)
- docs_together_ai__docs__how-to-improve-search-with-rerankers.md — MISSING
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 2, 3, 4)
...
- "especially when applied to out-of-domain datasets" — Found in Rank 2
...
**Document Match:** 1/2 (50%)
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 9)
...
**Document Match:** 2/2 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 5, 6)
- www_pinecone_io__learn__series__faiss__hnsw.md — Found (Rank 3, 4, 7, 8, 9, 10)

**Snippet Match:** 2/2 (100%)
- "index quality tradeoff is controlled via the efConstruction parameter" — Found in Rank 6
- "modifying three parameters: `M`, `efSearch`, and `efConstruction`" — Found in Rank 4
...
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 1, 5, 6)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 2, 3, 4, 7, 8, 9, 10)
- weaviate_io__blog__late-chunking.md — MISSING

**Snippet Match:** 1/3 (33%)
- "(64-128 tokens) are optimal for datasets with concise, fact-based answers" — Found in Rank 6
...
- "we find RRF to be sensitive to its parameters" — Found in Rank 1
- "convex combination outperforms RRF in in-domain and out-of-domain settings" — Found in Rank 1
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 7, 8, 9, 10)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 5, 6)
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 7, 10)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 5, 9)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 3, 7)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 4, 8)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — Found (Rank 5, 10)
- weaviate_io__blog__late-chunking.md — MISSING
- Beyond_Chunk_Then_Embed_Taxonomy.md — MISSING
