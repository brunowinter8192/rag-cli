...
**Mode:** cc_α0.9 | **Top-k:** 10 | **Timestamp:** 20260408_183747
...
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 5)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 4, 6)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 3, 4, 6, 10)
...
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 2, 3, 4, 10)
...
**Snippet Match:** 2/2 (100%)
- "uses two sub-techniques: Contextual Embeddings and Contextual BM25" — Found in Rank 5
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 4, 5, 6, 7, 8, 9)
...
- "modifying three parameters: `M`, `efSearch`, and `efConstruction`" — Found in Rank 6
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 8)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 2, 4)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 3, 5, 6, 7, 9, 10)
...
- "Lumber Chunker performs best for in-document retrieval" — Found in Rank 8
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 7, 9)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 5, 8)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 3, 4, 6)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 10)

**Snippet Match:** 2/3 (66%)
- "reduce the number of rows in index and reduce the concurrent queries" — Found in Rank 3
- "Are you setting your `list` size appropriately for your data set?" — Found in Rank 5
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 5, 8, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4, 7, 9)
