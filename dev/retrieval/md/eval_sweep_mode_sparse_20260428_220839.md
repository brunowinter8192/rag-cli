...
**Label:** sweep_mode_sparse | **Timestamp:** 20260428_220839

> ℹ **Note:** query_prefix=True is a no-op for mode=`sparse` — no dense embedding step.
...
| rrf_k | 60 |  |
| score_threshold | 0.0 |  |
| query_prefix | True | no-op — no dense embedding step for sparse/bm25 |
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 3, 6, 8, 10)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 1, 2, 4, 5, 7)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 8
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 1
...
**Document Match:** 2/2 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 1, 4, 6, 7, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 3, 5, 8, 9)

**Snippet Match:** 2/2 (100%)
- "when combined with reranking, by 67%" — Found in Rank 9
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 9)

**Snippet Match:** 2/2 (100%)
- "gets more than 40 MRR @ 10 on the MS MARCO dev set" — Found in Rank 2
- "SPLADE-v3 | 40.2 | 72.3 | 75.4" — Found in Rank 1
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 2, 3, 6, 8, 9)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 5, 7)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 4, 10)

**Snippet Match:** 1/2 (50%)
- "Qwen3-Embedding-8B/4096 achieves Top-3 accuracy" — MISSING
- "Qwen-3-Embedding-8B: 8B parameters, 4096 dimensions" — Found in Rank 4
...
**Document Match:** 1/1 (100%)
- docs_haystack_deepset_ai__docs__hypothetical-document-embeddings-hyde.md — Found (Rank 1, 2, 4, 5, 6)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 4, 6)

**Snippet Match:** 1/1 (100%)
- "_ef_construction_ is required to be 2x the value of _m_" — Found in Rank 2
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2)

**Snippet Match:** 1/2 (50%)
- "around the early 400 range is a good trade off" — Found in Rank 2
- "I will be using a 512 (for some reason I like this number)" — MISSING
...
- docs_voyageai_com__docs__reranker.md — MISSING
- docs_together_ai__docs__how-to-improve-search-with-rerankers.md — MISSING
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 2, 3, 4, 6, 7)
...
- "fast bi-encoder retrieval followed by accurate cross-encoder reranking" — Found in Rank 3
...
- Fusion_Functions_Hybrid_Retrieval.md — Found (Rank 1, 2, 5, 6, 8, 9, 10)
...
- "the two are complementary in how they model relevance" — MISSING
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 6, 8, 9)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 3, 4, 5, 7, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 3, 9)
...
**Snippet Match:** 1/2 (50%)
- "uses two sub-techniques: Contextual Embeddings and Contextual BM25" — Found in Rank 1
- "prepending chunk-specific explanatory context to each chunk before embedding" — MISSING
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 5, 9)
...
**Snippet Match:** 0/2 (0%)
- "SPLADE-v3 vastly outperforms BM25" — MISSING
...
**Document Match:** 1/2 (50%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 4, 5, 6)
- www_pinecone_io__learn__series__faiss__hnsw.md — MISSING

**Snippet Match:** 1/2 (50%)
- "index quality tradeoff is controlled via the efConstruction parameter" — Found in Rank 3
...
**Document Match:** 1/1 (100%)
- research_trychroma_com__context-rot.md — Found (Rank 1, 3, 4, 5, 6, 7, 8, 10)

**Snippet Match:** 1/2 (50%)
- "model performance degrades more significantly with increasing input length" — MISSING
- "needle-question pairs increases the rate of performance degradation" — Found in Rank 5
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 7, 9)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 5, 8)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 3, 4, 6, 10)
...
**Document Match:** 2/3 (66%)
- Fusion_Functions_Hybrid_Retrieval.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 9, 10)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — Found (Rank 8)
- www_anthropic_com__engineering__contextual-retrieval.md — MISSING
...
- "tuned RRF generalizes poorly to out-of-domain datasets" — Found in Rank 1
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 6, 8, 9, 10)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 5, 7)
- arxiv__2511.22240__pipeline-optimization.md — MISSING

**Snippet Match:** 2/2 (100%)
- "70.58 on the MTEB Multilingual benchmark" — Found in Rank 10
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 4, 5)
- www_crunchydata_com__blog__pgvector-performance-for-developers.md — Found (Rank 1, 8)
- www_crunchydata_com__blog__scaling-vector-data-with-postgres.md — Found (Rank 2, 3, 6)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 9, 10)

**Snippet Match:** 3/3 (100%)
- "reduce the number of rows in index and reduce the concurrent queries" — Found in Rank 2
- "Are you setting your `list` size appropriately for your data set?" — Found in Rank 8
- "pgvector 0.8.0 and iterative scans work as expected" — Found in Rank 10
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 4)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 5)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
- weaviate_io__blog__late-chunking.md — Found (Rank 9)
...
**Snippet Match:** 1/3 (33%)
- "prepending chunk-specific explanatory context to each chunk before embedding" — MISSING
- "only afterwards dividing these contextually-rich embeddings into chunks" — Found in Rank 9
...
| Metric | Value |
|--------|-------|
| Document Recall @10 (avg) | 79% |
| Snippet Recall @10 (avg) | 70% |
| Queries with 100% doc match | 11/20 |
| Queries with 100% snippet match | 10/20 |
| Queries with 0 snippet match | 1/20 |

### By Query Type
| Type | Count | Avg Doc Recall | Avg Snippet Recall |
|------|-------|---------------|-------------------|
| conceptual | 7 | 63% | 48% |
| cross-document | 5 | 69% | 73% |
| factual | 8 | 100% | 88% |
