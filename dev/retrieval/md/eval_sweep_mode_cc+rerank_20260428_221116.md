...
**Label:** sweep_mode_cc+rerank | **Timestamp:** 20260428_221116

**Config:**

| Param | Value | Note |
|-------|-------|------|
| mode | cc+rerank ← swept |  |
| top_k | 10 |  |
| alpha | 0.8 |  |
| rrf_k | 60 |  |
| score_threshold | 0.0 |  |
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 3, 4, 5, 7, 8, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 1, 6)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 9)
...
**Document Match:** 3/3 (100%)
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 3, 6, 9, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4, 5, 8)
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 1, 2, 3, 6, 8)
- research_trychroma_com__evaluating-chunking.md — Found (Rank 7)
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 4)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 5, 9)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 4, 9, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 5, 8)
