...
**Label:** sweep_alpha_0.6 | **Timestamp:** 20260428_221421
...
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 4, 5, 7, 9, 10)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 1
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 4
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 1, 2, 3, 4, 5, 6, 7, 8)
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 3, 6, 8, 9, 10)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 5, 9, 10)
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 4, 5, 6, 7, 8, 9)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 3, 10)
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 3, 4, 5, 6, 8)
...
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 4, 5)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 3, 6, 8, 9, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 3, 7)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2, 6)
