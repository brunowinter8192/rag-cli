...
**Label:** sweep_alpha_0.5 | **Timestamp:** 20260428_221417
...
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 3, 4, 6)
- www_thenile_dev__blog__pgvector-080.md — Found (Rank 2, 5, 7, 9, 10)

**Snippet Match:** 2/2 (100%)
- "_ef_search_ value is set to 40 (which is the default)" — Found in Rank 1
- "the default hnsw.ef_search of 40, only 4 rows will match on average" — Found in Rank 2
...
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 1, 3, 5, 7, 9, 10)
- arxiv__2511.22240__pipeline-optimization.md — Found (Rank 4)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 2, 6, 8)
...
**Document Match:** 1/1 (100%)
- www_crunchydata_com__blog__hnsw-indexes-with-postgres-and-pgvector.md — Found (Rank 1, 2, 3, 5, 8, 10)
...
**Document Match:** 1/1 (100%)
- medium.com__yashasvimantha_matryoshka-embeddings-finding-the-sweet-spot-between-embedding-size-and-retrieval-quality-for.md — Found (Rank 1, 2, 4, 5)

**Snippet Match:** 2/2 (100%)
- "around the early 400 range is a good trade off" — Found in Rank 2
- "I will be using a 512 (for some reason I like this number)" — Found in Rank 4
...
- "the two are complementary in how they model relevance" — Found in Rank 5
...
**Document Match:** 2/2 (100%)
- weaviate_io__blog__late-chunking.md — Found (Rank 1, 2, 4, 5, 6, 7, 10)
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 3, 8, 9)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 2, 3, 6, 7, 10)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 1, 4, 5, 8, 9)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — MISSING
...
- arxiv__2403.06789__splade-v3.md — Found (Rank 2, 3, 4, 5, 6, 9)
...
- www_pinecone_io__learn__series__faiss__hnsw.md — Found (Rank 7, 8, 9, 10)
...
- "needle-question pairs increases the rate of performance degradation" — Found in Rank 8
...
- Beyond_Chunk_Then_Embed_Taxonomy.md — Found (Rank 7, 10)
- research_trychroma_com__evaluating-chunking.md — MISSING
- Rethinking_Chunk_Size_Long_Document_Retrieval.md — Found (Rank 4, 6)
- zilliz_com__learn__guide-to-chunking-strategies-for-rag.md — Found (Rank 1, 2, 3, 5, 8, 9)
...
**Document Match:** 2/3 (66%)
- arxiv__2506.05176__qwen3-embedding.md — Found (Rank 6, 7, 9)
- medium.com__mrAryanKumar_comparative-analysis-of-qwen-3-and-bge-m3-embedding-models-for-multilingual-information-retriev.md — Found (Rank 1, 2, 3, 4, 5, 8, 10)
...
- www_anthropic_com__engineering__contextual-retrieval.md — Found (Rank 3)
- www_anthropic_com__news__contextual-retrieval.md — Found (Rank 2)
- docs_together_ai__docs__how-to-implement-contextual-rag-from-anthropic.md — Found (Rank 5)
- weaviate_io__blog__late-chunking.md — MISSING
