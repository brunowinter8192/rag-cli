...
### One CLI: cli.py With 10 Subcommands
...
### Canonical Path: data/documents/\<collection\>/
...
### Source Removal as Default on Delete
...
### Subcommands Not Migrated (Removed)
...
### Multi-Model Variant Switching Removed From Rules
